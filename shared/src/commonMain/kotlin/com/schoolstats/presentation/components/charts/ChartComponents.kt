package com.schoolstats.presentation.components.charts
...
import com.schoolstats.presentation.components.LegendDot
...
fun DonutChartCard(
    ...
    SectionCard(title, modifier = modifier) {
        ...
        @Composable
        fun LegendBlock(legendModifier: Modifier) {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp), modifier = legendModifier) {
        ...
        if (stacked) {
            Column(verticalArrangement = Arrangement.spacedBy(12.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                Canvas(Modifier.height(160.dp).fillMaxWidth()) {
                    val stroke = 36f
                    val diameter = min(size.minDimension - 8f, 148f)
                ...
                LegendBlock(Modifier.fillMaxWidth())
            }
        } else {
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(24.dp)) {
                ...
                LegendBlock(Modifier.weight(1f))
            }
        }
    }
}
